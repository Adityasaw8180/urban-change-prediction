...
function App() {
  ...
  const handleAnalyze = () => {
    ...
    if (currentResults) return // already computed

    setLoading(true)

    setTimeout(() => {
      // Demo calculation – replace with real backend call
  ...
  // ... rest of the file remains the same (imports, state, handleAnalyze, etc.)
